...
clang-cl %clang_flags_debug_easy%  ..\src\examples\rendertexture.c ..\src\vkal.c ..\src\platform.c -o rendertexture.exe /I%vulkan_include% /I%glfw_include% /link %vulkan_lib_64%\vulkan-1.lib %glfw_lib_64%\glfw3dll.lib
