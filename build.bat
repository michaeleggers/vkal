...
clang-cl %clang_flags_debug_easy%  ..\src\examples\model_loading_md.c ..\src\examples\utils\tr_math.c ..\src\examples\utils\model.c ..\src\vkal.c ..\src\platform.c -o clang_dbg_model_loading_md.exe /I%vulkan_include% /I%glfw_include% /link %vulkan_lib_64%\vulkan-1.lib %glfw_lib_64%\glfw3dll.lib
clang-cl %clang_flags_debug_easy_cpp%  ..\src\examples\model_loading_md_glm.cpp ..\src\examples\utils\tr_math.c ..\src\vkal.c ..\src\platform.c -o clang_dbg_model_loading_md_glm.exe /I%vulkan_include% /I%glfw_include% /I%glm_include% /link %vulkan_lib_64%\vulkan-1.lib %glfw_lib_64%\glfw3dll.lib
