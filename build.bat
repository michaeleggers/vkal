...
set flags_debug=   -std=c99 -m64 -Wall -Wextra -pedantic-errors -fextended-identifiers -Wno-unused-parameter -Wno-unused-variable -Wno-missing-braces -g -D DEBUG -D VKAL_GLFW -I%vulkan_include% -I%glfw_include%
...
set clang_flags_debug_easy= /TC /Z7 /DDEBUG /W4 /MDd -DVKAL_GLFW -Qunused-arguments -Wno-unused-variable -ferror-limit=100
...
REM gcc %flags_debug%  ..\src\main.c ..\src\vkal.c -L%vulkan_lib_64%\ -L%glfw_lib_64%\ -l:vulkan-1.lib -l:glfw3dll.lib -o gcc_dbg_main 
